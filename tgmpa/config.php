...
add_action( 'tgmpa_register', 'bstr_register_required_plugins' );

/**
 * Register TGM options.
 */
function bstr_register_required_plugins() {
	...
	$config = array(
		'id'           => 'BSTR',                   // Unique ID for hashing notices for multiple instances of TGMPA.
		...
		'strings'      => array(
			'page_title'                     => __( 'Install Required Plugins', 'bstr_lang' ),
			'menu_title'                     => __( 'Install Plugins', 'bstr_lang' ),
			/* translators: %s: plugin name. */
			'installing'                     => __( 'Installing Plugin: %s', 'bstr_lang' ),
			/* translators: %s: plugin name. */
			'updating'                       => __( 'Updating Plugin: %s', 'bstr_lang' ),
			'oops'                           => __( 'Something went wrong with the plugin API.', 'bstr_lang' ),
